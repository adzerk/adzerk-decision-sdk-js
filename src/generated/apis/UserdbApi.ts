...
export class UserdbApi extends runtime.BaseAPI {
     ...
     */
    async addCustomPropertiesRaw(requestParameters: AddCustomPropertiesRequest): Promise<runtime.ApiResponse<Blob>> {
     ...
     * Add Custom Properties to a User
     */
    async addCustomProperties(networkId: number, userKey: string, body?: object): Promise<Blob> {
        const response = await this.addCustomPropertiesRaw({ networkId: networkId, userKey: userKey, body: body });
     ...
     */
    async addInterestsRaw(requestParameters: AddInterestsRequest): Promise<runtime.ApiResponse<Blob>> {
        if (requestParameters.networkId === null || requestParameters.networkId === undefined) {
     ...
     * Add Interests to a User
     */
    async addInterests(networkId: number, userKey: string, interest: string): Promise<Blob> {
        const response = await this.addInterestsRaw({ networkId: networkId, userKey: userKey, interest: interest });
        return await response.value();
    }
     ...
     */
    async addRetargetingSegmentRaw(requestParameters: AddRetargetingSegmentRequest): Promise<runtime.ApiResponse<Blob>> {
        if (requestParameters.networkId === null || requestParameters.networkId === undefined) {
     ...
     * Add User to a Retargeting Segment
     */
    async addRetargetingSegment(networkId: number, advertiserId: number, retargetingSegmentId: number, userKey: string): Promise<Blob> {
        const response = await this.addRetargetingSegmentRaw({ networkId: networkId, advertiserId: advertiserId, retargetingSegmentId: retargetingSegmentId, userKey: userKey });
        return await response.value();
    }
     ...
     * GDPR Consent
     */
    async gdprConsentRaw(requestParameters: GdprConsentRequest): Promise<runtime.ApiResponse<Blob>> {
        if (requestParameters.networkId === null || requestParameters.networkId === undefined) {
    ...
    async gdprConsent(networkId: number, consentRequest?: ConsentRequest): Promise<Blob> {
        const response = await this.gdprConsentRaw({ networkId: networkId, consentRequest: consentRequest });
        return await response.value();
    }
     ...
     * IP Address Override
     */
    async ipOverrideRaw(requestParameters: IpOverrideRequest): Promise<runtime.ApiResponse<Blob>> {
        if (requestParameters.networkId === null || requestParameters.networkId === undefined) {
    ...
    async ipOverride(networkId: number, userKey: string, ip: string): Promise<Blob> {
        const response = await this.ipOverrideRaw({ networkId: networkId, userKey: userKey, ip: ip });
        return await response.value();
    }
     ...
     * User Matching
     */
    async matchUserRaw(requestParameters: MatchUserRequest): Promise<runtime.ApiResponse<Blob>> {
        if (requestParameters.networkId === null || requestParameters.networkId === undefined) {
     ...
     * User Matching
     */
    async matchUser(networkId: number, userKey: string, partnerId: number, userId: number): Promise<Blob> {
        const response = await this.matchUserRaw({ networkId: networkId, userKey: userKey, partnerId: partnerId, userId: userId });
        return await response.value();
    }
